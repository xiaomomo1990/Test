...
BootStrap.layout = {
            ...
            _layout
                .each(function () {
                    ...
                    $this._size = {
                        ...
                        south: [$this._dragArea.bottom.x2, $this._opt.layoutHeight - $this._dragArea.top.y2],
    ...
    _split: function (_that, _lspH, _lspV) {
        ...
        //        _lspH.bind("mouseup", function () {
        //            //拖动释放，重绘布局
        //            $this._dragRelease(_lspH, _that, $this);
        //        });
    ...
    _dragRelease: function (_lspV, _that, $this) {
        ...
        //        }
        //        else if ($this.thisDrag == "right") {
        //            var val1 = $this._opt.layoutWidth - $this._dragArea.right.x2,
        //                val2 = $this._dragArea.right.x1 - $this._dragArea.left.x2,
        //                val3 = $this._dragArea.right.x2;

        //            $this._size.west[0] = val1;
        //            $this._size.center[0] = val2;
        //            $this._location.west[0] = val3;
        //        }
        //重绘
        $this._layout();
    },
